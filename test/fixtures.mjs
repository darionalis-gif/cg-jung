...
export const drafts = {
  ...
  series: { practice: 'series', step: 'reading', startedAt: at(49), data: { line: 'From the first to the last the water goes from black to clear to gone; the dog goes from blocking the stairs to leading down them; my father goes from a coat on a hook to a man holding a light; and my mother, who I did not know was in it, is under the lake with the bells.', motif: 'The dog. Unchanged in itself, its place changes: stairs, street, garden. And the coat, which I wore once and then he wore again.', doing: 'The series is handing the work over: to the dog, then to my father with the light. It is taking the carrying out of my hands one dream at a time, and I keep waking before I let it.' } },
