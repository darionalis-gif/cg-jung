...
6. Stage transitions of place as a beat with a "blackout" effect at 0 plus "world" changes and moves, or by having the old scenery vanish and the new appear. Actors that are not yet in the story start hidden and get "appear"; actors that leave get "vanish" (both happen within about a quarter of the beat unless you give "for"). Hidden actors still need a pos. Things a person carries or wears (money, a bag, a hat, a camera) are not separate actors unless the dream makes them act: name them in the person's label instead ("me, with my money"). A moon or sun is a disc at exactly its pos: put it 60-150 m away and 25-60 m up on the side the camera will face.
