...
| XII | Union with the body · *coniunctio II* | Seven days after the first: the caelum against the body, in whose presence it is hardest, a daily bodily practice, the body's revolt on return, the moment it was true in the flesh, which can only be written on a return at least a week later, once the practice has been asked about. Stays open until then. |
